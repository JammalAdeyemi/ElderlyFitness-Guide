export const poseInstructions = {
    ...
    BentOverRow: [ 'Stand with your feet shoulder-width apart. Hold a dumbbell in each hand with your arms by your sides, palms facing inwards.',
        'Bend your knees slightly, then bend forwards from the hips, keeping your back straight. Lower the weights towards the floor.',
        'Keep your elbows tucked in and raise the weights to your sides, squeezing your shoulder blades together at the top of the movement.',
        'Slowly lower the weights back down.',
        'Repeat for the desired number of repetitions.',
        'Source: https://weighttraining.guide/exercises/bent-over-two-arm-dumbbell-row/'],

    ChairSquat: ['Start Position: Stand in front of a chair with your feet hip-width apart, toes pointing forward. Keep your arms at your sides or extend them out in front of you for balance.',
        'Begin the movement by pushing your hips back as if you are about to sit down. Bend at your knees and lower your body toward the chair. Keep your chest upright and your back straight. Make sure your knees are in line with your feet and do not extend beyond your toes.',
        "When your glutes touch the chair, pause for a moment. Don't relax or sit down completely; keep your muscles engaged.",
        'Push through your heels to stand back up to the starting position. Make sure to keep your back straight and your chest lifted.',
        'Perform the desired number of repetitions.',
        'Source: https://workoutlabs.com/exercise-guide/chair-squats/'],

    PushUps: ['Start in a high plank position with your palms flat, hands shoulder-width apart, shoulders stacked directly above your wrists, legs extended behind you, and your core and glutes engaged.',
    ...
    Sit_to_Stand:[
        ...
        'Repeat for the desired number of repetitions.',
        'Remember to use your abdominal muscles, not your neck or shoulders.',
        'Consult a fitness professional if unsure about the correct form.',
        'Source: https://www.healthline.com/health/fitness-exercise/sit-ups'
    ]
    ,
   
    Setups: [
        "Lie down on a mat with knees bent, feet flat, and hands behind your head.",
        "Engage your core and lift your upper body towards your thighs.",
        "Keep lifting until your chest is close to your knees.",
        "Lower your body back to the starting position.",
        "Repeat for the desired number of reps.",
        "Use your abs to lift your body, not your neck or shoulders.",
        "Consult a fitness professional if unsure about form.",
        "Source: https://www.wikihow.com/Do-Sit-Ups"
    ],
}
